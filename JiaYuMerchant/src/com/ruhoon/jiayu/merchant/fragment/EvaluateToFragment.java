...
public class EvaluateToFragment extends Fragment {
	Context context;
	String type;
	View view;
	...
	public EvaluateToFragment(Context context, String type) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		RequestQueueSingleton.getInstance(context).addToRequestQueue(
				dataRequestVolley);
		view = inflater.inflate(R.layout.evaluate_to_fragment, null);
		return view;
	}
